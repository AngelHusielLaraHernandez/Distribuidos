...
\begin{document}
    ...
    \subsection{Que es IDL, XDR, y Protocol Buffers}


    \subsection{Tipos en datos a usar en XDR y protocol Buffers}


    \subsection{Investigar el signiﬁcado de los números que aparecen en un archivo .x y archivo .proto}
